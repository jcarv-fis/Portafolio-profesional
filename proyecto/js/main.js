...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const translations = {
    es: {
      ...
      about_title: 'Desarrollador backend orientado a la arquitectura de software',
      about_p1: 'Soy desarrollador de software especializado en backend. Diseño la lógica de negocio, la estructura de datos y la arquitectura que hay detrás de cada aplicación: lo que el usuario no ve, pero es lo que sostiene todo.',
      about_p2: 'Trabajo principalmente con Java y Spring Boot, además de .NET, diseñando y consumiendo APIs REST sobre bases de datos relacionales, con arquitectura por capas y código limpio. Me caracterizo por la responsabilidad, la organización y el aprendizaje constante, y disfruto construir en equipo soluciones que resuelvan problemas reales.',
    ...
    en: {
      ...
      about_title: 'Backend developer focused on software architecture',
      about_p1: "I'm a software developer specialized in backend. I design the business logic, data structure and architecture behind every application: what the user does not see, but what holds everything together.",
      about_p2: 'I work mainly with Java and Spring Boot, along with .NET, designing and consuming REST APIs over relational databases, with layered architecture and clean code. I stand out for responsibility, organization and constant learning, and I enjoy building team solutions that solve real problems.',
